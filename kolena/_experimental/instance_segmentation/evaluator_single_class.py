...
class SingleClassInstanceSegmentationEvaluator(SingleClassObjectDetectionEvaluator):
    """
    The `SingleClassInstanceSegmentationEvaluator` transforms inferences into metrics for
    the Instance Segmentation workflow for a single class.
