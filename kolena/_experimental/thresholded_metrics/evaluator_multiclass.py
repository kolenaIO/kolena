...
from kolena._experimental.thresholded_metrics import ClassMetricsPerTestCase
from kolena._experimental.thresholded_metrics import GroundTruth
from kolena._experimental.thresholded_metrics import Inference
from kolena._experimental.thresholded_metrics import TestCase
from kolena._experimental.thresholded_metrics import TestCaseMetrics
from kolena._experimental.thresholded_metrics import TestSample
from kolena._experimental.thresholded_metrics import TestSampleMetrics
from kolena._experimental.thresholded_metrics import TestSuite
from kolena._experimental.thresholded_metrics import TestSuiteMetrics
from kolena._experimental.thresholded_metrics import ThresholdConfiguration
from kolena._experimental.thresholded_metrics.utils import compute_average_precision
from kolena._experimental.thresholded_metrics.utils import compute_optimal_f1_threshold_multiclass
from kolena._experimental.thresholded_metrics.utils import compute_pr_curve
from kolena._experimental.thresholded_metrics.utils import filter_inferences
from kolena._experimental.thresholded_metrics.utils import get_thresholds
from kolena._experimental.thresholded_metrics.workflow import TestSampleThresholdedMetricsSingleClass as TestSampleThresholdedMetrics
...
class MulticlassObjectDetectionEvaluator(Evaluator):
    ...
    def test_sample_metrics(
        ...
        for threshold in thresholds:
            tp = [inf for _, inf in bbox_matches.matched if inf.score >= threshold]
            fp = [inf for inf in bbox_matches.unmatched_inf if inf.score >= threshold]
        ...
        return TestSampleMetrics(
            ignored=False,
            Class1=thresholded_metrics,
            Class2=thresholded_metrics,
        )
        ...
        mean_aps = [
            np.mean(
                [
                    ...
                    for threshold_metric in metric.Class1
                ],
            )
