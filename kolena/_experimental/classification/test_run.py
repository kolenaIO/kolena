...
def test(
    ...
    """
    Convenience alias for [`test`][kolena.workflow.test] configured for the pre-built Classification
    workflow.

    Tests the provided [`Model`][kolena.classification.Model] on the provided
    [`TestSuite`][kolena.classification.TestSuite]. Any test already in progress for this model on this
