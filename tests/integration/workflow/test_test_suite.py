...
def test__load_all(with_init: None) -> None:
    ...
    _, _, TestSuite2, _ = define_workflow(f"{workflow} 2", DummyTestSample, DummyGroundTruth, DummyInference)
    ...
    TestSuite2(name, tags={name})  # create another kolena.workflow test suite with a different workflow
