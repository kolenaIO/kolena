        ...
        (
            ...
            [
                ...
                CurvePlot(
                    ...
                    curves=[
                        Curve(
                            x=[0.3, 0.4, 0.5, 0.6, 0.7, 0.8, 0.85, 0.88, 0.9, 0.95, 0.99, 1.0],
                            y=[
                                0.6559139784946236,
                                0.6413043478260869,
                                0.5955056179775281,
        ...
        (
            ...
            [
                ...
                CurvePlot(
                    ...
                    curves=[
                        Curve(
                            x=[0.1, 0.2, 0.25, 0.3, 0.4, 0.5, 0.6, 0.7, 0.8, 0.85, 0.88, 0.9, 0.95, 0.99, 1.0],
                            y=[
                                0.676923076923077,
                                0.6631578947368421,
                                0.648936170212766,
        ...
        (
            ...
            [
                ...
                CurvePlot(
                    ...
                    curves=[
                        ...
                        Curve(
                            ...
                            y=[0.7142857142857143, 0.6666666666666666, 0.6, 0.5, 0.3333333333333333],
                            label="e",
                        ),
                    ],
                    x_config=None,
                ...
                ConfusionMatrix(
                    ...
                    labels=["a", "b", "c", "d", "e"],
                    matrix=[[31, 2, 0, 0, 0], [0, 12, 0, 0, 0], [0, 0, 14, 0, 0], [0, 0, 0, 2, 0], [0, 1, 0, 0, 3]],
                    x_label="Predicted",
                    y_label="Actual",
                ),
            ],
            ...
            [
                CurvePlot(
                    ...
                    curves=[
                        ...
                        Curve(
                            x=[0.4, 0.5, 0.6, 0.7, 0.9, 0.95, 0.99, 1.0],
                            y=[
                                0.4166666666666667,
                                0.34782608695652173,
                                0.3,
                        ...
                        Curve(x=[0.6, 0.7, 0.8], y=[0.4, 0.28571428571428575, 0.15384615384615383], label="e"),
                    ],
                    x_config=None,
                    y_config=None,
                ),
                CurvePlot(
                    ...
                    curves=[
                        ...
                        Curve(
                            x=[0.4166666666666667, 0.3333333333333333, 0.25, 0.25, 0.25, 0.0, 0.0, 0.0],
                            y=[0.4166666666666667, 0.36363636363636365, 0.375, 0.4, 0.42857142857142855, 0.0, 0.0, 0.0],
                            label="b",
                        ),
                        Curve(
                            x=[
                        ...
                        Curve(x=[0.3, 0.2, 0.1], y=[0.6, 0.5, 0.3333333333333333], label="e"),
                    ],
                    x_config=None,
                    y_config=None,
                ),
            ...
            [
                ...
                CurvePlot(
                    ...
                    curves=[
                        ...
                        Curve(x=[0.4, 0.3, 0.2, 0.1], y=[0.6666666666666666, 0.6, 0.5, 0.3333333333333333], label="e"),
                    ],
                    x_config=None,
                    y_config=None,
                ),
