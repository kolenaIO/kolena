...
def main(args: Namespace) -> None:
    ...
    test_suites: List[Tuple[str, Callable[[str, TestCase], TestSuite]]] = [
        (f"2 Classes :: {DATASET} :: [{WORKFLOW}]", seed_test_suite_by_brightness),
        (f"5 Classes :: {DATASET} :: [{WORKFLOW}]", seed_test_suite_by_bounding_box_size),
        (f"10 Classes :: {DATASET} :: [{WORKFLOW}]", seed_test_suite_by_bounding_box_size),
        (f"20 Classes :: {DATASET} :: [{WORKFLOW}]", seed_test_suite_by_bounding_box_size),
    ]
